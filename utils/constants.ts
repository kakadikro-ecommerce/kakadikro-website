export const generalFaqs = [
    {
        question: "Are your spices sourced directly from farms ?",
        answer:
            "Yes, we source our spices directly from trusted farms across India, ensuring freshness, purity, and authentic flavor in every product.",
    },
    {
...
export const trackOrderFAQs = [
    ...
    },
    {
        ...
        answer:
            "Yes. Once your order is dispatched, you will receive a tracking ID. You can use this tracking ID on the courier partner’s website to get real-time delivery updates.",
    },
    {
        question: "Can I cancel my order after placing it ?",
        answer:
            "Yes, you can cancel your order if its status is still 'Pending' or 'Confirmed'. Once the order is dispatched, cancellation is no longer possible.",
    },
    {
        question: "Can I cancel my order after it is dispatched ?",
        answer:
            "No, once your order has been dispatched, it cannot be canceled. However, you may contact support for further assistance if needed.",
    },
    {
        question: "Where can I see my order history ?",
        answer:
            "You can view your complete order history by clicking on the 'Order History' button in your account section.",
    },
    {
